    ...
    try {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($newfirstname === '') {
                ...
                echo "newfname blah".$newfirstname;
                ...
                echo "newfname shi".$row['firstname'];
            ...
            if ($newlastname === '') {
                ...
                echo "newlname blah".$newlastname;
            
            }elseif($newfirstname){
                $row['lastname'] = $getuserlname;
                echo "newlname shi".$row['lastname'];
            ...
            if ($newusername === '') {
                ...
                echo "user blah".$newlastname;

            }elseif($newfirstname){
                $row['username'] = $getuserusername;
                echo "user shi".$row['username'];
            }
