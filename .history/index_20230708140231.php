...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $updatestmt = $conn->prepare("UPDATE jamevectory SET firstname = :newfirstname, lastname = :newlastname, username = :newusername, email = :email , password = :password , bio = :bio WHERE id = :userid");
