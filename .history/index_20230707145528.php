...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['submit'])) {
        ...
        $filename = $uploaddir . $_FILES['profile']['name'];

        $pathinfo = pathinfo($filename,PATHINFO_EXTENSION);
        

         $uniqid = $uniqid.'.'. $pathinfo;
        echo "<pre>" . print_r($uploadfile, true) . "</pre>";


        if (move_uploaded_file($_FILES['profile']['tmp_name'], $uniqid)) {
            echo "successfully";
        } else {
            echo "failded";
        }
                ...
                <div class="edit-form">
                    <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="user-selection">
                            <div class="user-img">
                                <div class="img-item">
                                    <img src="./assets/img/profile/<?php echo $uniqid ?>.jpg" alt="" width="150px">
